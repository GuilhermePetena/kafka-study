...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Cliente> clienteConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(Cliente.class, false));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Cliente> clienteKafkaListenerContainerFactory() {
